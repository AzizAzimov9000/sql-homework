...
else 'Sufficient' end StockStatus from products
 
select count(*) as numbercustomer, country from Customers
group by country
...
select sum(SaleAmount), ProductID from Sales
group by ProductID
